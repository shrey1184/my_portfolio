    ...
    <>
      ...
      >
        ...
        <div style={{
          ...
          pointerEvents: 'none',
          zIndex: 1,
        }} className="home-border-desktop"></div>
        ...
        <div style={{
          ...
          pointerEvents: 'none',
          zIndex: 1,
        }} className="home-border-mobile"></div>
        ...
        <div className="home-content" style={{
          ...
          <span className="system-font home-label" style={{ fontSize: '1.5rem', fontWeight: '200', marginBottom: '0rem', letterSpacing: '1px' }}>home</span>
          
          <h1 className="home-title" style={{ fontSize: '6.5rem', fontWeight: '600', margin: 0, lineHeight: 1, fontFamily: 'StarCrush, sans-serif' }}>
            Hi, I'm
          ...
          <span className="home-subtitle" style={{ fontSize: '1.5rem', fontWeight: '200', marginBottom: '0rem', letterSpacing: '1px', lineHeight: '2', fontFamily: 'StarCrush, sans-serif' }}>
